...
public class MapUtil {
    static public double computeDistanceBetween(City c1, City c2) {
    ...
    static public Point2D SphericalMercatorProject(double latitude, double longitude) {
    ...
    static public Point2D SphericalMercatorProject(City city) {
        return SphericalMercatorProject(city.getLatitude(), city.getLongitude());
    }

    static public Point boundingBoxScale(Point2D input, int width, int height) {
